...
plateCascade = cv2.CascadeClassifier("C:\\Users\\aryat\\OneDrive\\Pictures\\New folder (3)\\DeteksiPlatNomor-main\\haarcascade_russian_plate_number.xml")
...
while True:
    ...
    if k%256 == 27:
        ...
        cv2.imwrite("C:/Users/aryat/OneDrive/Pictures/New folder (3)/DeteksiPlatNomor-main/data/data"+str(count)+".jpg", imgRoi)
